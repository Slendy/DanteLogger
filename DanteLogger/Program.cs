...
if (args.Length > 0)
{
    ...
    {
        Log.Information("DanteLogger v{Tag} {GitCommit}", ThisAssembly.Git.BaseTag, ThisAssembly.Git.Commit);
        return;
    }
...
try
{
    ...
    Log.Information("Version: {Version}, Commit {Commit}", ThisAssembly.Git.BaseTag, ThisAssembly.Git.Commit);
